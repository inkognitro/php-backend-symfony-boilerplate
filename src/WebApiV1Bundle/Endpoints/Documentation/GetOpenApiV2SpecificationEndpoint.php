...
namespace App\WebApiV1Bundle\Endpoints\Documentation;
...
final class GetOpenApiV2SpecificationEndpoint implements Endpoint
{
    ...
    {
        $urlFragments = UrlFragments::fromStrings(['documentation', 'openApiV2Specification']);
        ...
        $endpointSchema = $endpointSchema->setTags(['General']);
